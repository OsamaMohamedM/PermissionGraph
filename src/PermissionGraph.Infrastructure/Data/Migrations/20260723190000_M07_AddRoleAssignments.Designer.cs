...
namespace PermissionGraph.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260723190000_M07_AddRoleAssignments")]
    partial class M07_AddRoleAssignments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PermissionGraph.Domain.Memberships.Models.OrganizationMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PermissionGraph.Domain.Organizations.Models.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PermissionGraph.Domain.Permissions.Models.PermissionDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PermissionGraph.Domain.Projects.Models.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PermissionGraph.Domain.Roles.Models.Role", b =>
                {
                    ...
                    b.ToTable("Roles", null, t =>
                        {
                            t.HasCheckConstraint("CK_Roles_Lifecycle", "((\"IsActive\" = TRUE AND \"ArchivedAtUtc\" IS NULL) OR (\"IsActive\" = FALSE AND \"ArchivedAtUtc\" IS NOT NULL))");

                            t.HasCheckConstraint("CK_Roles_RoleType", "\"RoleType\" IN ('System', 'Custom')");

                            t.HasCheckConstraint("CK_Roles_ScopeType", "\"ScopeType\" IN ('Organization', 'Project')");
                        });
                });

            modelBuilder.Entity("PermissionGraph.Domain.Roles.Models.RolePermission", b =>
                {
                    b.Property<Guid>("RoleId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PermissionGraph.Domain.Roles.Models.RolePermission", b =>
                {
                    b.HasOne("PermissionGraph.Domain.Permissions.Models.PermissionDefinition", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PermissionGraph.Infrastructure.Projects.ProjectAdministratorAssignmentRecord", b =>
                {
                    ...
                    b.HasOne("PermissionGraph.Domain.Projects.Models.Project", null)
                        .WithMany()
